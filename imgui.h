...
namespace ImGui
{
    ...
    IMGUI_API void          ShowStyleEditorCN(ImGuiStyle* ref = NULL);  
...
IMGUI_API const char*   GetStyleColorNameCN(ImGuiCol idx);          // get a string corresponding to the enum value (for display, saving, etc.).
